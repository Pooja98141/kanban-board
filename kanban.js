...
function addTask(){
let newT =document.getElementById('taskText').value;
console.log(newT);
document.getElementById('newTasks').innerHTML+=`<article class="card" draggable="true" ondragstart="drag(event)" data-id="3">
<h3>${newT}</h3></article>`;
}
